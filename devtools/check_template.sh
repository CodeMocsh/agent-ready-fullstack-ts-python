...
# The schema baseline. Without it `make schema` re-records an edited body, and the gate that
# refuses an edited shipped entry stops refusing anything.
need backend/.schema-baseline.json
